 ...
 * (GenCodeChecksum:3578358dcd2a8262dc347319cf2be907)
 */
...
class CRM_CiviGeometry_DAO_Geometry extends CRM_Core_DAO {
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'archived_date' => [
          ...
          'title' => CRM_CiviGeometry_ExtensionUtil::ts('Archived Date'),
          'description' => CRM_CiviGeometry_ExtensionUtil::ts('The Title of this geometry'),
          'required' => FALSE,
  ...
  public static function indices($localize = TRUE) {
    $indices = [
      'index_geometry_type_label_is_archived' => [
        'name' => 'index_geometry_type_label_is_archived',
        'field' => [
          0 => 'geometry_type_id',
          1 => 'label',
          2 => 'is_archived',
        ...
        'localizable' => FALSE,
        'sig' => 'civigeometry_geometry::0::geometry_type_id::label::is_archived',
      ],
    ];
