 ...
 * (GenCodeChecksum:419ad38d0b98331696cecfedaecf36b6)
 */
  ...
  public static function indices($localize = TRUE) {
    $indices = [
      'index_collection_id_geometry_id' => [
        'name' => 'index_collection_id_geometry_id',
        'field' => [
          0 => 'collection_id',
          1 => 'geometry_id',
        ],
        'localizable' => FALSE,
        'unique' => TRUE,
        'sig' => 'civigeometry_geometry_collection_geometry::1::collection_id::geometry_id',
      ],
    ];
