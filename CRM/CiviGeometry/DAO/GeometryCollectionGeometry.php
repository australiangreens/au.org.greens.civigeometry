 ...
 * (GenCodeChecksum:0eca0ad0d49e8fbb13b96a368132e178)
 */
...
class CRM_CiviGeometry_DAO_GeometryCollectionGeometry extends CRM_Core_DAO {
  ...
  public static function getReferenceColumns() {
    if (!isset(Civi::$statics[__CLASS__]['links'])) {
      ...
      Civi::$statics[__CLASS__]['links'][] = new CRM_Core_Reference_Basic(self::getTableName(), 'geometry_collection_id', 'civigeometry_geometry_collection', 'id');
  ...
  public static function indices($localize = TRUE) {
    $indices = [
      'index_geometry_id_geometry_collection_id' => [
        'name' => 'index_geometry_id_geometry_collection_id',
        'field' => [
          0 => 'geometry_id',
          1 => 'geometry_collection_id',
        ],
        'localizable' => FALSE,
        'unique' => TRUE,
        'sig' => 'civigeometry_geometry_collection_geometry::1::geometry_id::geometry_collection_id',
      ],
    ];
