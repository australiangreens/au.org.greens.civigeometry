...
CREATE TABLE `civigeometry_geometry` (
  ...
  PRIMARY KEY (`id`),
  INDEX `index_geometry_type_label_is_archived`(geometry_type_id, label, is_archived),
...
CREATE TABLE `civigeometry_geometry_collection_geometry` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `index_geometry_id_collection_id`(geometry_id, collection_id),
...
CREATE TABLE `civigeometry_geometry_entity` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `UI_geometry_id_entity_id_entity_table`(geometry_id, entity_id, entity_table),
