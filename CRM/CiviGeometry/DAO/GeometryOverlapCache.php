 ...
 *
 * Generated from /home/seamus/buildkit/build/47-test/sites/default/files/civicrm/ext/au.org.greens.civigeometry/xml/schema/CRM/CiviGeometry/GeometryOverlapCache.xml
 * DO NOT EDIT.  Generated by CRM_Core_CodeGen
 * (GenCodeChecksum:4e3999bbb20471713793cc11cd4b9a67)
 */
...
class CRM_CiviGeometry_DAO_GeometryOverlapCache extends CRM_Core_DAO {
   ...
   * @var string
   */
  static $_tableName = 'civigeometry_geometry_overlap_cache';
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'geometry_id_a' => [
          'name' => 'geometry_id_a',
          'type' => CRM_Utils_Type::T_INT,
          'title' => CRM_CiviGeometry_ExtensionUtil::ts('Geometry ID A'),
        ...
        'geometry_id_b' => [
          'name' => 'geometry_id_b',
          'type' => CRM_Utils_Type::T_INT,
          'title' => CRM_CiviGeometry_ExtensionUtil::ts('Geometry ID B'),
          'description' => CRM_CiviGeometry_ExtensionUtil::ts('Geometry'),
          'table_name' => 'civigeometry_geometry_overlap_cache',
          'entity' => 'GeometryOverlapCache',
          'bao' => 'CRM_CiviGeometry_DAO_GeometryOverlapCache',
        ...
        'overlap' => [
          'name' => 'overlap',
          'type' => CRM_Utils_Type::T_INT,
          'title' => CRM_CiviGeometry_ExtensionUtil::ts('Overlap'),
          'description' => CRM_CiviGeometry_ExtensionUtil::ts('Overlap % that Geometry A is within Geometry B'),
          'required' => TRUE,
          'default' => '0',
          'table_name' => 'civigeometry_geometry_overlap_cache',
          'entity' => 'GeometryOverlapCache',
        ...
        'cache_date' => [
          ...
          'title' => CRM_CiviGeometry_ExtensionUtil::ts('Cache Date'),
          'description' => CRM_CiviGeometry_ExtensionUtil::ts('When was this overlap last re-generated'),
          'required' => TRUE,
