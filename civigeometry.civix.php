 ...
 */
function _civigeometry_civix_civicrm_config(&$config = NULL) {
 ...
 */
function _civigeometry_civix_civicrm_xmlMenu(&$files) {
  foreach (_civigeometry_civix_glob(__DIR__ . '/xml/Menu/*.xml') as $file) {
    $files[] = $file;
  }
}
 ...
 */
function _civigeometry_civix_civicrm_install() {
 ...
 */
function _civigeometry_civix_civicrm_upgrade($op, CRM_Queue_Queue $queue = NULL) {
  if ($upgrader = _civigeometry_civix_upgrader()) {
...
/**
 * @return CRM_CiviGeometry_Upgrader
 */
function _civigeometry_civix_upgrader() {
  if (!file_exists(__DIR__ . '/CRM/CiviGeometry/Upgrader.php')) {
    return NULL;
  }
  else {
    return CRM_CiviGeometry_Upgrader_Base::instance();
  }
}
 ...
 */
function _civigeometry_civix_civicrm_managed(&$entities) {
  $mgdFiles = _civigeometry_civix_find_files(__DIR__, '*.mgd.php');
  sort($mgdFiles);
 ...
 */
function _civigeometry_civix_civicrm_caseTypes(&$caseTypes) {
  if (!is_dir(__DIR__ . '/xml/case')) {
    return;
  }

  foreach (_civigeometry_civix_glob(__DIR__ . '/xml/case/*.xml') as $file) {
 ...
 */
function _civigeometry_civix_civicrm_angularModules(&$angularModules) {
  if (!is_dir(__DIR__ . '/ang')) {
    return;
  }

  $files = _civigeometry_civix_glob(__DIR__ . '/ang/*.ang.php');
 ...
 */
function _civigeometry_civix_civicrm_themes(&$themes) {
  $files = _civigeometry_civix_glob(__DIR__ . '/*.theme.php');
  foreach ($files as $file) {
 ...
 * missing them.
 */
function _civigeometry_civix_fixNavigationMenu(&$nodes) {
  $maxNavID = 1;
  ...
  _civigeometry_civix_fixNavigationMenuItems($nodes, $maxNavID, NULL);
}

function _civigeometry_civix_fixNavigationMenuItems(&$nodes, &$maxNavID, $parentID) {
  ...
  foreach ($origKeys as $origKey) {
    ...
    if (isset($nodes[$origKey]['child']) && is_array($nodes[$origKey]['child'])) {
      _civigeometry_civix_fixNavigationMenuItems($nodes[$origKey]['child'], $maxNavID, $nodes[$origKey]['attributes']['navID']);
    }
  }
}
 ...
 */
function _civigeometry_civix_civicrm_alterSettingsFolders(&$metaDataFolders = NULL) {
